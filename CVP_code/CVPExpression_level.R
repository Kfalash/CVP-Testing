...
ZT2 <- read.table("ZT2_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT2)
...
ZT4 <- read.table("ZT4_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT4)
...
ZT6 <- read.table("ZT6_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT6)
...
ZT8 <- read.table("ZT8_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT8)
...
ZT10 <- read.table("ZT10_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT10)
...
ZT12 <- read.table("ZT12_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT12)
...
ZT16 <- read.table("ZT16_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT16)
...
ZT18 <- read.table("ZT18_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT18)
...
ZT20 <- read.table("ZT20_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT20)
...
ZT22 <- read.table("ZT22_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT22)
...
ZT24 <- read.table("ZT0_HVG_LVG_random.txt",header=TRUE,sep='\t')
dim(ZT24)
...
HVG <- read.table("HVG_allZT_background.txt", header=TRUE, sep='\t')
dim(HVG)
[1] 1358    2
...
LVG <- read.table("LVG1000_allZT_background.txt", header=TRUE, sep='\t')
dim(LVG)
[1] 5727    2
...
nbZT_variable <- read.table("HVG_allZT_nbZT.txt",header=TRUE, sep='\t')
